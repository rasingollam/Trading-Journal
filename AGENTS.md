...
- When user asked implement the plan, implement the attached plan end to end, compile code and test for coding bugs, refine then docker build and up the project.
